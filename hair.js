var vineDemo = function (canvas, bgColor) {
	...
	var controlBones = [
		...
		, "bone20", "bone21", "bone22", "bone23",	"bone24", "bone25", "bone26",	"bone27", "bone28", "bone29"
	...
	function loadingComplete() {
		...
		var mesh = skeleton.getAttachment("hairstyle", "hairstyle");
		...
		mesh.vertices[0] = 100; // x of vertex 0
		mesh.vertices[1] = 200; // y of vertex 0
		mesh.vertices[2] = 300; // x of vertex 1
		mesh.vertices[3] = 400; // y of vertex 1
	...
	function render() {
		...
		for (var i = 0; i < controlBones.length; i++) {
			...
			renderer.circle(true, skeleton.x + bone.worldX, skeleton.y + bone.worldY, 100, colorInner);
			renderer.circle(false, skeleton.x + bone.worldX, skeleton.y + bone.worldY, 100, colorOuter);
		}
		gl.lineWidth(1);
		renderer.end();
	}
