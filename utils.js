var spineDemos = {
   HOVER_COLOR_INNER: new spine.Color(0, 0, 0, 0),
   HOVER_COLOR_OUTER: new spine.Color(0, 0, 0, 0),
   NON_HOVER_COLOR_INNER: new spine.Color(0, 0, 0, 0),
   NON_HOVER_COLOR_OUTER: new spine.Color(0, 0, 0, 0),
   demos: [],
   loopRunning: false,
   canvases: [],
